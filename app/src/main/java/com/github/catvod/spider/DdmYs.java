 ...
 * Author: 群友 不负此生
 */
public class DdmYs extends Spider {
    ...
    private String getSearchUrl(String URL, String KEY) {
        ...
        } else if (URL.contains("api.php/app0823") || URL.contains("xgapp")) {
            return URL + "search?token=RJyEWQxFkp5zfn6e2FKSMejJepcAfxrY&text=" + KEY + "&pg=";
    ...
    private String UA(String URL) {
        if (URL.contains("api.php/app0823") || URL.contains("xgapp") || URL.contains("freekan")) {
    ...
    String getCateUrl(String URL) {
        if (URL.contains("api.php/app0823") || URL.contains("xgapp")) {
            return URL + "nav?token=RJyEWQxFkp5zfn6e2FKSMejJepcAfxrY";
        } else if (URL.contains(".vod")) {
            if (URL.contains("iopenyun.com")) {
    ...
    String getCateFilterUrlPrefix(String URL) {
        if (URL.contains("api.php/app0823") || URL.contains("xgapp")) {
            if (URL.contains("d8jx")) {
                URL = "http://dy.d8jx.com:93/api.php/app0823/";
                return URL + "video?token=RJyEWQxFkp5zfn6e2FKSMejJepcAfxrY&tid=";
            } else {
    ...
    String getPlayUrlPrefix(String URL) {
        if (URL.contains("api.php/app0823") || URL.contains("xgapp")) {
            if (URL.contains("d8jx")) {
                URL = "http://dy.d8jx.com:93/api.php/app0823/";
                return URL + "video_detail?token=RJyEWQxFkp5zfn6e2FKSMejJepcAfxrY&id=";
    ...
    private void genPlayList(String URL, JSONObject object, String json, JSONObject vod, String vid) throws JSONException {
        ...
        if (URL.contains("api.php/app0823/")) {
